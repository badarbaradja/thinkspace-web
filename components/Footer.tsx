        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-3 mt-6">
              {/* Instagram */}
              <a
                href="https://www.instagram.com/thinkspace.app"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram"
                className="w-9 h-9 rounded-lg bg-white/5 hover:bg-accent/20 hover:text-accent flex items-center justify-center transition-colors text-slate-400"
              >
              ...
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/company/thinkspacesapp/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="w-9 h-9 rounded-lg bg-white/5 hover:bg-accent/20 hover:text-accent flex items-center justify-center transition-colors text-slate-400"
